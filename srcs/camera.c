...
/*   Updated: 2023/05/25 21:37:12 by hyunjuki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	It is assumed that axes are extrinsically rotated by phi first and 
	intrinsically rotated by theta.
	
	when calculating phi, orient.x and orient.y are multiplied by -1 
	as z axis of a camera must be facing opposite direction of the camera 
	orientation due to the fact that z axis is flipped by convention.
*/
